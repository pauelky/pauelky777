...
welcome_message = (
    "🛡 <b>SavedBot — личный архив Telegram</b>\n\n"
    "Я аккуратно сохраняю то, что обычно пропадает без следа:\n"
    "• удалённые и отредактированные сообщения\n"
    "• медиафайлы, документы, кружочки и голосовые\n"
    "• одноразовые вложения и истории правок\n"
    "• статистику по чатам и последним событиям\n\n"
    "Подключение занимает меньше минуты. Выберите удобный способ ниже."
)

BOT_COMMANDS_BRIEF = (
    "\n\n<b>Команды SavedBot:</b>\n"
    "• /start — открыть приветствие и центр управления\n"
    "• /set — настройки бота и прослушивания чатов\n"
    "• /stats — статистика сохранённого архива\n"
    "• /profile — профиль и статус доступа\n"
